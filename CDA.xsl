	...
	<xsl:template name="section-author">
		<xsl:if test="count(n1:author)&gt;0">
			<div style="margin-left : 2em;">
				<b>
					<xsl:text>Section Author(s): </xsl:text>
				</b>
				<br/>
				<xsl:for-each select="n1:author/n1:assignedAuthor">
					<xsl:choose>
...
<metaInformation>
	<scenarios>
		<scenario default="no" name="Scenario1" userelativepaths="yes" externalpreview="no" url="LRN CCD with Care Plan 20131021.xml" htmlbaseurl="" outputurl="" processortype="saxon8" useresolver="no" profilemode="0" profiledepth="" profilelength=""
		...
		<scenario default="yes" name="Scenario with output to browser" userelativepaths="yes" externalpreview="yes" url="CarePlan(Clinical)_A3_2014-09-18.xml" htmlbaseurl="" outputurl="" processortype="saxon8" useresolver="no" profilemode="0"
